...
voidbasics() // for basics
{
    ...
    char bot[] = "zxcvbv /.,mnm";
    cout << "\n\nHello! I think you are a new to the world of fast typing.";
    delay(1000);
    cout << "\n\nAnd as I am now your tutor and have agreed to teach you how to be fast in typing......";
    delay(1000);
    ...
    {
        clrscr();
        cout << "\n\nUnderstand, it is quite simple to do this....";
        delay(1000);
        cout << "\n\nFollow me.......";
        delay(1000);
        ...
        delay(1000);
        cout << "\n\nFirst you will have to learn the mid row.....";
        ...
        cout << "\n\nType what you see on the screen...DO NOT LOOK AT YOUR KEYBOARD";
        for (int i = 0; i < rep; ++i)
        {
            for (int j = 0; j < 13; ++j)
            {
        ...
        // Top row
        cout << "\n\nNow you will have to learn the top row.....";
        cout << "\n\nHow many times do you want to practice : ";
        cin >> rep;
        cout << "\n\nDo you want to see the finger positioning ?(y/n)";
        cin >> choice2;
        ...
        // Bottom Row
        cout << "\n\nLastly you have to learn the bottom row.....";
        cout << "\n\nHow many times do you want to practice : ";
        cin >> rep;
        cout << "\n\nDo you want to see the finger positioning ?(y/n)";
        cin >> choice2;
        ...
        cout << "\n\nType what you see as the letters appear on screen...DO NOT LOOK AT YOUR KEYBOARD";
        for (i = 0; i < rep; ++i)
        {
            for (int j = 0; j < 13; ++j)
            {
...
type:
    ...
    time_t t3, t4;
    char linee[300];
    cout << "This is a test to try your speed.\n";
    delay(1000);
typee:
    cout << "\nYou will have to type the sentence given.\n";
    delay(1000);
    ...
    t3 = time(NULL);
    cout << "I am studying in VIIT.";
    cout << "\n\nEnter the sentence:";
    gets(linee);
    t4 = time(NULL);
    if (!strcmp(linee, "I am studying in VIIT."))
    {
        cout << "\n\nYou could type the sentence in " << t4 - t3 << " seconds.";
        getch();
    }
    else
    {
